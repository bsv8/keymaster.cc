...
Object.assign(resources.resources.en as Record<string, string>, {
  ...
  "storage.settings.statusUnconfigured": "Not configured",
      ...
      "storage.bucketManager.passwordNote": "The bucket password exists only for the current test and save operation. It is not written to the catalog or long-lived Coordinator state. Cold export reads only the committed snapshot.",
      ...
      "storage.bucketManager.err.conditionalWrites": "The bucket cannot provide usable conditional writes (atomic or best-effort)",
      ...
      "storage.bucketManager.renameTitle": "Rename bucket",
      "storage.bucketManager.capability.native": "Native conditional writes",
      "storage.bucketManager.capability.bestEffort": "Simulated conditional writes",
      "storage.bucketManager.capability.unknown": "Not probed",
      "storage.bucketManager.reprobe": "Re-probe conditional writes",
      "storage.bucketManager.reprobeTitle": "Re-probe conditional write capability",
      "storage.bucketManager.reprobeHint": "Enter this bucket's password for a one-time probe. The result is saved to the local device record and is no longer probed automatically.",
      "storage.bucketManager.reprobeSubmit": "Start probe",
      "storage.bucketManager.err.reprobe": "Conditional write probe failed.",
      "storage.bucketManager.err.reprobeLocked": "Unlock the current bucket before re-probing conditional writes.",
      "storage.bucketManager.renameField": "New bucket name",
      "storage.bucketManager.renameSubmit": "Save name",
      "storage.bucketManager.err.renameEmpty": "Enter a bucket name.",
      ...
      "storage.bucketKeys.empty": "This bucket has no Keys yet.",
      "storage.bucketKeys.unnamed": "Unnamed Key",
      "storage.bucketKeys.delete": "Delete",
      "storage.bucketKeys.err.probe": "Storage probe is unavailable",
      "storage.bucketKeys.err.delete": "Failed to delete the Key"
});
...
Object.assign(resources.resources["zh-CN"] as Record<string, string>, {
  ...
  "storage.settings.statusUnconfigured": "未配置",
      ...
      "storage.bucketManager.passwordNote": "桶密码只用于当前测试和保存操作；不会写入目录或长期 Coordinator 状态。冷导出只读取已提交快照。",
      ...
      "storage.bucketManager.err.conditionalWrites": "桶无法提供可用的条件写入（原子或 best-effort 模拟）",
      ...
      "storage.bucketManager.renameTitle": "重命名存储桶",
      "storage.bucketManager.capability.native": "原生条件写",
      "storage.bucketManager.capability.bestEffort": "模拟条件写",
      "storage.bucketManager.capability.unknown": "未探测",
      "storage.bucketManager.reprobe": "重新探测条件写",
      "storage.bucketManager.reprobeTitle": "重新探测条件写能力",
      "storage.bucketManager.reprobeHint": "输入该桶的桶密码，仅用于本次探测；结果会写回本机记录，之后不再自动探测。",
      "storage.bucketManager.reprobeSubmit": "开始探测",
      "storage.bucketManager.err.reprobe": "重新探测条件写失败。",
      "storage.bucketManager.err.reprobeLocked": "请先解锁当前桶再重新探测条件写。",
      "storage.bucketManager.renameField": "新的桶名称",
      "storage.bucketManager.renameSubmit": "保存名称",
      "storage.bucketManager.err.renameEmpty": "请输入桶名称。",
      ...
      "storage.bucketKeys.empty": "这个桶还没有 Key。",
      "storage.bucketKeys.unnamed": "未命名 Key",
      "storage.bucketKeys.delete": "删除",
      "storage.bucketKeys.err.probe": "存储探测不可用",
      "storage.bucketKeys.err.delete": "删除 Key 失败"
});
