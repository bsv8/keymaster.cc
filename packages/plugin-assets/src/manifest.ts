...
const assetsResources: I18nPluginResources = {
  ...
  resources: {
    ...
    "zh-CN": {
      ...
      "assets.homeWidget.address": "地址",
      "assets.homeWidget.copy": "拷贝",
      "assets.homeWidget.copied": "已复制",
      "assets.homeWidget.mainnet": "主网",
      "assets.homeWidget.testnet": "Testnet",
      "assets.homeWidget.holdings": "资产",
      "assets.homeWidget.itemCount": "{{count}} 项",
