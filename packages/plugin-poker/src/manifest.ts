...
const pokerResources: I18nPluginResources = {
  ...
  resources: {
    en: {
      ...
      "poker.settings.locked": "Wallet is locked; unlock to continue configuring.",
      "poker.table.locked": "Wallet is locked; unlock to continue.",
    ...
    "zh-CN": {
      ...
      "poker.settings.label": "Poker",
      "poker.settings.locked": "钱包已锁定；解锁后可继续配置。",
      "poker.table.locked": "钱包已锁定；解锁后可继续。",
      "poker.settings.description": "代理端点与广播策略。",
