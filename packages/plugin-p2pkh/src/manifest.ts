...
const p2pkhResources: I18nPluginResources = {
  ...
  resources: {
    en: {
      ...
      "p2pkh.task.recent.description": "Replace the active key's UTXO snapshot from WOC; reconcile reservations and pending transfers.",
    ...
    "zh-CN": {
      ...
      "p2pkh.task.recent.description": "用 WOC 替换 active key 的 UTXO 快照；对账 reservation 与 pending transfer。",
