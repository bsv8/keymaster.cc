...
const p2pkhResources: I18nPluginResources = {
  ...
  resources: {
    en: {
      ...
      "p2pkh.transfer.result.rejected": "Broadcast was rejected by the network. No reservation was written.",
      "p2pkh.transfer.result.unknown": "Broadcast result is unknown. The inputs have been reserved locally.",
      "p2pkh.transfer.result.broadcast": "The final preview transaction was broadcast and reserved locally.",
    ...
    "zh-CN": {
      ...
      "p2pkh.transfer.result.txid": "txid：",
      "p2pkh.transfer.result.rejected": "广播被网络拒绝，未写入 reservation。",
      "p2pkh.transfer.result.unknown": "广播结果未知，已为本次输入写入 reservation。",
      "p2pkh.transfer.result.broadcast": "已广播最终预览交易，并写入 reservation。",
