...
const p2pkhResources: I18nPluginResources = {
  ...
  resources: {
    en: {
      ...
      "p2pkh.provider.description": "BSV P2PKH transfers: bsv / bsvtest networks.",
      ...
      "p2pkh.settings.description": "P2PKH asset policies (unconfirmed UTXOs, etc.). WOC settings are on the WOC page.",
      "p2pkh.home.balance": "P2PKH balance",
      "p2pkh.task.recent.label": "P2PKH recent sync",
      "p2pkh.task.recent.description": "Check balance, UTXOs, recent history, and reconcile reservations (by active key namespace).",
      ...
      "p2pkh.activity.pendingLocal": "Local pending broadcast",
      ...
      "p2pkh.col.reservation": "Local reservation",
      "p2pkh.col.spendable": "Spendable",
      "p2pkh.col.spendable.yes": "Yes",
      "p2pkh.col.spendable.no": "No",
      "p2pkh.col.reservation.empty": "None",
      "p2pkh.col.reservation.spending": " (spending ",
      "p2pkh.col.reservation.ellipsis": "…)",
      ...
      "p2pkh.balance.line": "Balance: confirmed {{confirmed}} · unconfirmed {{unconfirmed}}",
      ...
      "p2pkh.utxos.desc": "WOC UTXO snapshot + local reservation overlay. Reserved UTXOs are excluded from allocation.",
      "p2pkh.settings.title": "P2PKH settings",
      "p2pkh.settings.desc": "P2PKH asset policies. WOC endpoint, rate limit, and broadcast are configured on the WOC settings page.",
      "p2pkh.settings.allowUnconfirmed": "Allow unconfirmed UTXOs",
      "p2pkh.settings.allowUnconfirmed.yes": "Yes",
      "p2pkh.settings.allowUnconfirmed.no": "No (recommended)",
      ...
      "p2pkh.transfer.allKey": " All keys (read-only overview, cannot sign)",
      "p2pkh.transfer.unnamed": "Unnamed",
      "p2pkh.transfer.identityMissing": "Identity not available",
      "p2pkh.transfer.loading": "Loading…",
      "p2pkh.transfer.unselected": "Unselected",
      "p2pkh.transfer.changeAddress": "Current change address: ",
      "p2pkh.transfer.result.title": "Submission result",
      "p2pkh.transfer.result.status": "Status: ",
      "p2pkh.transfer.result.txid": "txid: ",
      "p2pkh.transfer.result.rejected": "Transaction was rejected by the network. The UTXO reservation has been released.",
      "p2pkh.transfer.result.unknown": "Broadcast result is unknown. The UTXO is kept as a reservation to prevent double spend.",
      "p2pkh.transfer.result.broadcast": "Reservation created for the inputs. The next recent-sync will observe whether it confirms on chain.",
      "p2pkh.transfer.result.confirmClose": "Confirm and close",
      "p2pkh.transfer.result.again": "Start over",
      "p2pkh.transfer.allModeWarning": "Currently in \"all keys\" read-only mode. Pick a specific key in the topbar to transfer.",
      ...
      "p2pkh.transfer.form.allowUnconfirmed": "Allow unconfirmed UTXOs",
      "p2pkh.transfer.form.allowUnconfirmed.yes": "Yes",
      "p2pkh.transfer.form.allowUnconfirmed.no": "No (recommended)",
      "p2pkh.transfer.form.prepare": "Prepare preview",
      "p2pkh.transfer.form.sign": "Sign and broadcast",
      "p2pkh.transfer.preview.title": "Preview",
      "p2pkh.transfer.preview.utxosCount": "Selected UTXOs: {{count}}",
      "p2pkh.transfer.preview.totalSats": " total, ",
      "p2pkh.transfer.preview.change": "Change: ",
      "p2pkh.transfer.preview.fee": "Estimated fee: ",
      "p2pkh.transfer.preview.satsUnit": " sats",
      "p2pkh.transfer.err.recipient": "Please enter a recipient address",
      "p2pkh.transfer.err.amount": "Amount must be a positive integer",
      "p2pkh.transfer.err.fee": "Invalid fee rate",
    ...
    "zh-CN": {
      "p2pkh.provider.name": "P2PKH",
      "p2pkh.provider.description": "BSV P2PKH 转移：bsv / bsvtest 两个网络。",
      ...
      "p2pkh.settings.label": "P2PKH",
      "p2pkh.settings.description": "P2PKH 资产策略（未确认 UTXO 等）。WOC 设置请到独立 WOC 设置页。",
      "p2pkh.home.balance": "P2PKH 余额",
      "p2pkh.task.recent.label": "P2PKH 近期同步",
      "p2pkh.task.recent.description": "检查余额、UTXO、近期 history 与 reservation 对账（按 active key namespace）。",
      ...
      "p2pkh.activity.pendingLocal": "本地待广播",
      ...
      "p2pkh.balance.line": "余额：确认 {{confirmed}} · 未确认 {{unconfirmed}}",
      ...
      "p2pkh.utxos.desc": "WOC UTXO 真值快照 + 本地 reservation 覆盖层。已 reservation 的 UTXO 不会参与分配。",
      "p2pkh.settings.title": "P2PKH 设置",
      "p2pkh.settings.desc": "P2PKH 资产策略。WOC endpoint、限流、广播在 WOC 设置页配置。",
      "p2pkh.settings.allowUnconfirmed": "允许未确认 UTXO",
      "p2pkh.settings.allowUnconfirmed.yes": "是",
      "p2pkh.settings.allowUnconfirmed.no": "否（推荐）",
      ...
      "p2pkh.transfer.allKey": " 全部 key（只读总览，无法签名）",
      "p2pkh.transfer.unnamed": "未命名",
      "p2pkh.transfer.identityMissing": "身份不可用",
      "p2pkh.transfer.loading": "加载中…",
      "p2pkh.transfer.unselected": "未选择",
      "p2pkh.transfer.changeAddress": "当前找零地址：",
      "p2pkh.transfer.result.title": "提交结果",
      "p2pkh.transfer.result.status": "状态：",
      "p2pkh.transfer.result.txid": "txid：",
      "p2pkh.transfer.result.rejected": "交易被网络拒绝。已释放本次 UTXO 占用。",
      "p2pkh.transfer.result.unknown": "广播结果未知，UTXO 已保留为 reservation 状态以防重复花费。",
      "p2pkh.transfer.result.broadcast": "已为本次输入创建 reservation。后续 recent-sync 会观察是否上链。",
      "p2pkh.transfer.result.confirmClose": "确认并关闭",
      "p2pkh.transfer.result.again": "再来一次",
      "p2pkh.transfer.allModeWarning": "当前是\"全部 key\"只读模式。请到顶栏选择一个具体的 key 后再转账。",
      ...
      "p2pkh.transfer.form.allowUnconfirmed": "允许未确认 UTXO",
      "p2pkh.transfer.form.allowUnconfirmed.yes": "是",
      "p2pkh.transfer.form.allowUnconfirmed.no": "否（推荐）",
      "p2pkh.transfer.form.prepare": "准备预览",
      "p2pkh.transfer.form.sign": "签名并广播",
      "p2pkh.transfer.preview.title": "预览",
      "p2pkh.transfer.preview.utxosCount": "选定 UTXO：{{count}} 个",
      "p2pkh.transfer.preview.totalSats": "，合计 ",
      "p2pkh.transfer.preview.change": "找零：",
      "p2pkh.transfer.preview.fee": "估算矿工费：",
      "p2pkh.transfer.preview.satsUnit": " sats",
      "p2pkh.transfer.err.recipient": "请输入接收方地址",
      "p2pkh.transfer.err.amount": "金额必须为正整数",
      "p2pkh.transfer.err.fee": "矿工费无效",
