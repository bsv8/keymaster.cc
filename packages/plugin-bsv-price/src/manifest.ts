...
const bsvPriceResources: I18nPluginResources = {
  ...
  resources: {
    en: {
      ...
      "bsv-price.page.empty.waitingSnapshot": "(waiting for next snapshot)",
      "bsv-price.page.empty.receiving": "(no quote in the current snapshot)",
      "bsv-price.page.empty.notConfigured": "Publisher is not configured; enter the PriceCast publisher public key.",
      ...
      "bsv-price.home.empty.receiving": "No quote in the current snapshot",
      "bsv-price.home.empty.notConfigured": "Enter the PriceCast publisher public key",
      ...
      "bsv-price.settings.action.notConfigured": "Enter the PriceCast publisher public key.",
      "bsv-price.settings.action.offline": "Unlock or re-enter the current owner.",
      "bsv-price.settings.action.satNotConfigured": "Configure and enable a receive Supplier.",
      "bsv-price.settings.action.satConnecting": "Check the Supplier address and connection.",
      "bsv-price.settings.action.satBalanceRequired": "Refresh the SPI balance and top up SatSubscription.",
      "bsv-price.settings.action.satIdentityError": "Check the Supplier public key, Peer ID, and address.",
      "bsv-price.settings.action.subscriptionUnknown": "Do not repeat a chargeable subscription; wait for reconciliation.",
      "bsv-price.settings.action.satSubscriptionError": "Use the stable error code in SatSubscription settings.",
      "bsv-price.settings.action.waitingSnapshot": "No action is required; wait for the first price snapshot.",
      "bsv-price.settings.action.receiving": "No action is required.",
      "bsv-price.settings.action.idle": "Price subscription is idle.",
    ...
    "zh-CN": {
      ...
      "bsv-price.page.empty.notConfigured": "未配置价格发布器，请填写 PriceCast 发布器公钥。",
      ...
      "bsv-price.home.empty.receiving": "当前快照没有报价",
      "bsv-price.home.empty.notConfigured": "请填写 PriceCast 发布器公钥",
      ...
      "bsv-price.settings.action.notConfigured": "请填写 PriceCast 发布器公钥。",
      "bsv-price.settings.action.offline": "请解锁或重新进入当前 Owner。",
      "bsv-price.settings.action.satNotConfigured": "请配置并启用接收 Supplier。",
      "bsv-price.settings.action.satConnecting": "请检查 Supplier 地址及连接状态。",
      "bsv-price.settings.action.satBalanceRequired": "请刷新 SPI 余额并为 SatSubscription 充值。",
      "bsv-price.settings.action.satIdentityError": "请检查 Supplier 公钥、Peer ID 和地址。",
      "bsv-price.settings.action.subscriptionUnknown": "请勿重复发起收费订阅，等待系统对账。",
      "bsv-price.settings.action.satSubscriptionError": "请根据稳定错误码前往 SatSubscription 设置处理。",
      "bsv-price.settings.action.waitingSnapshot": "无需操作，等待首个价格快照。",
      "bsv-price.settings.action.receiving": "无需操作。",
      "bsv-price.settings.action.idle": "价格订阅处于空闲状态。",
      "bsv-price.settings.clearHint":
