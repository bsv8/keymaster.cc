...
export type MsFileP2pLaneOperation =
  ...
  | { type: "bitfs-webrtc-buyer-offer"; /** 买方本地会话编号。 */ sessionId: string; /** ChannelProtocol Hash 请求 message_id。 */ requestMessageId: string; /** ChannelProtocol WebRTC session_id。 */ webrtcSessionId: string; /** offer 发送者压缩公钥 hex。 */ publicKeyHex: string; /** ChannelProtocol 已验签 offer 的 SDP。 */ offerSdp: string }
