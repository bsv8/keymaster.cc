...
const vaultResources: I18nPluginResources = {
  ...
  resources: {
    en: {
      ...
      "vault.create.description": "Set a local password. The password is used to encrypt all private keys and is never sent to any server. If lost, it cannot be recovered.",
    ...
    "zh-CN": {
      ...
      "vault.create.title": "创建钱包",
      "vault.create.description": "设置一个本地密码。该密码用于加密所有私钥，不会发送到任何服务器，丢失后无法找回。",
      "vault.create.passwordNew": "新密码",
      "vault.create.passwordConfirm": "确认密码",
      "vault.create.submit": "创建钱包",
