...
const messageResources: I18nPluginResources = {
  ...
  resources: {
    en: {
      ...
      "message.page.online.placeholder": "publicKeyHex (66 hex chars)",
    ...
    "zh-CN": {
      ...
      "message.page.online.placeholder": "publicKeyHex (66 个 hex)",
