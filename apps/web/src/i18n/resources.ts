...
export const SHELL_RESOURCES: I18nPluginResources = {
  ...
  resources: {
    en: {
      ...
      "shell.locked.card.newBody": "Set a local password and create an empty BSV wallet. You can import a key later.",
      ...
      "shell.locked.newWalletDesc": "Set a local password. The password is stored only on this device and is used to encrypt your keys.",
    ...
    "zh-CN": {
      ...
      "shell.locked.card.newBody": "设置一个本地密码，创建一个空的 BSV 钱包。之后可以再导入私钥。",
      ...
      "shell.locked.newWalletDesc": "设置一个本地密码。该密码仅保存在本机，用于加密你的私钥。",
