...
if (missing.length > 0) {
  ...
  const result = spawnSync(
    "pnpm",
    ["exec", "playwright", "test", "--config=e2e/playwright.deployment.config.ts", "--project=deployment-acceptance", "e2e/integration/gates/deployment/plugin-lifecycle-irreversible-io.spec.ts"],
